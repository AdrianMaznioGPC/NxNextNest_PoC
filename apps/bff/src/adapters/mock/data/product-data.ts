...
const frProducts: BaseProduct[] = [
  record("p-1",  "plaquettes-de-frein-en-ceramique",        "Plaquettes de frein en céramique",        "Plaquettes de frein céramique haute performance pour moins de poussière et de bruit. Compatible avec la plupart des berlines et SUV.",              "1486262715619-67b85e0b08d3", "Essieu",            [{ id: "var-front-0", label: "Avant" }, { id: "var-rear-1", label: "Arrière" }]),
  record("p-2",  "disques-de-frein-perces-et-rainures",    "Disques de frein percés et rainurés",     "Disques de frein percés et rainurés pour une meilleure dissipation de la chaleur et une puissance de freinage accrue.",                              "1492144534655-ae79c964c9d7", "Taille",            [{ id: "var-12-in-0", label: "12 pouces" }, { id: "var-13-in-1", label: "13 pouces" }]),
  record("p-3",  "filtre-a-air-performance",                "Filtre à air performance",                "Filtre à air haute performance lavable et réutilisable. Augmente le débit d'air pour une meilleure réponse à l'accélérateur.",                     "1489824904134-891ab64532f1", "Montage",           [{ id: "var-universal-0", label: "Universel" }, { id: "var-direct-fit-1", label: "Montage direct" }]),
  record("p-4",  "bougies-d-allumage-iridium",              "Bougies d'allumage iridium (lot de 4)",   "Bougies d'allumage à pointe iridium longue durée pour un allumage fiable et une efficacité énergétique optimale.",                                 "1517524008697-84bbe3c3fd98", "Indice thermique",  [{ id: "var-6-0", label: "6" }, { id: "var-7-1", label: "7" }, { id: "var-8-2", label: "8" }]),
  record("p-5",  "kit-combines-filetes-reglables",          "Kit combinés filetés réglables",          "Kit de suspension combinés filetés à hauteur réglable. Amortissement réglable 32 voies pour route et circuit.",                                     "1494976388531-d1058494cdd8", "Montage",           [{ id: "var-front-&-rear-set-0", label: "Ensemble avant et arrière" }]),
  record("p-6",  "biellettes-de-barre-stabilisatrice",      "Biellettes de barre stabilisatrice",      "Biellettes de barre stabilisatrice renforcées avec silentblocs en polyuréthane pour un meilleur maintien en virage.",                               "1504215680853-026ed2a45def", "Position",          [{ id: "var-front-0", label: "Avant" }, { id: "var-rear-1", label: "Arrière" }]),
  record("p-7",  "ampoules-led-phares",                     "Ampoules LED phares (paire)",             "Ampoules LED 6000K blanc brillant pour phares. Remplacement plug-and-play avec ventilateur de refroidissement intégré.",                            "1605559424843-9e4c228bf1c2", "Taille d'ampoule", [{ id: "var-h11-0", label: "H11" }, { id: "var-9005-1", label: "9005" }, { id: "var-9006-2", label: "9006" }]),
  record("p-8",  "caches-feux-arriere-fumes",               "Caches feux arrière fumés",               "Caches feux arrière fumés résistants aux UV pour un look personnalisé et élégant.",                                                                "1609521263047-f8f205293f24", "Montage",           [{ id: "var-universal-0", label: "Universel" }]),
  record("p-9",  "ligne-d-echappement-cat-back",            "Ligne d'échappement cat-back",            "Ligne d'échappement cat-back en acier inoxydable avec doubles sorties polies. Ajoute de la puissance et un son sportif.",                           "1552519507-da3b142c6e3d", "Style de sortie",   [{ id: "var-polished-0", label: "Poli" }, { id: "var-burnt-titanium-1", label: "Titane brûlé" }]),
